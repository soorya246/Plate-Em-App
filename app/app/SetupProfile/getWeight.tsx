...
const GetWeight = ({ currentStep, setCurrentStep }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titleText}>How much do you weigh?</Text>
      ...
      <View style={styles.unitSelector}>
        ...
        >
          <Text style={[styles.unitButtonText, unit === 'kg' ? styles.unitButtonTextSelected : {}]}>KG</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.unitButton, unit === 'lb' ? styles.unitButtonSelected : {}]}
          onPress={() => toggleUnit('lb')}
        >
          <Text style={[styles.unitButtonText, unit === 'lb' ? styles.unitButtonTextSelected : {}]}>LB</Text>
        </TouchableOpacity>
      </View>
