...
export default function LunchScreen() {
    ...
    const foodData = [
      { id: '1', name: 'Chicken Sandwich', calories: 297, protein: 29.7, icon: 'fast-food' },
      { id: '2', name: 'Pumpkin Pie', calories: 195, protein: 2, icon: 'pie-chart' },
      { id: '3', name: 'Cheese Pizza', calories: 201, protein: 6, icon: 'pizza' },
    ];
